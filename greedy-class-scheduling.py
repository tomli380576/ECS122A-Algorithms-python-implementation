...
def greedySchedule() -> list[str]:
    ...
    # In this case we don't need to permute START_TIMES becasue we can directly access by key
    # So the order in START_TIMES doesn't matter because we are using dict
