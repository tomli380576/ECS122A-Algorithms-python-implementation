...
if __name__ == "__main__":
    ...
    print(f"{list(reversed(lib_sort1))} is how the library sorts DIRECTED_ACYCLIC_1")
    print(
        f"{list(sorted_dict2.keys())} is 1 way of topologically sorting DIRECTED_ACYCLIC_2"
    )
    print(f"{list(reversed(lib_sort2))} is how the library sorts DIRECTED_ACYCLIC_2")
