...
def SubsetSum_First(nums: list[int], curr_subset: list[int],
                    target: int) -> bool:
    '''
...
def SubsetSum_All(nums: list[int], curr_subset: list[int], target: int,
    ...
    for idx, num in enumerate(nums):
        ...
        '''
        SubsetSum_All(nums[idx + 1:], curr_subset + [num], target - num,
                      working_subsets)
